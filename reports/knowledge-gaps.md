...
Generated 2026-07-24 from the retrieval index. This lists where the grounded assistant has thin or missing coverage, so records can be improved. It contains no invented content — only coverage diagnostics.
